# 4. Patrimonio (resto del menú)

Todo esto está bajo **Patrimonio** ▾.
...
Inmuebles u otros bienes raíces, con valuación y vínculo opcional a un pasivo (hipoteca).
...
Stock valuado (sobre todo útil con WooCommerce). Suma al patrimonio de la empresa si está incluido.

## Participaciones

Quién es dueño de qué empresa y en qué %.  
Es el puente entre **empresa** y **patrimonio personal**.

## Regla mental del neto
...
← [Cuentas y movimientos](03-cuentas-y-movimientos.md) · [Índice](README.md) · [Presupuestos](05-presupuestos.md) →
